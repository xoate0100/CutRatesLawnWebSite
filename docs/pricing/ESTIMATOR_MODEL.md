...
| Fertilization | `CRL_Lights_Landing` KC-Fert | **$39**/mo ≤ 5,000 sq ft; +**$1.40**/mo per 100 sq ft above 5,000 |
| Margin / labor | `Financial_Operating_Structure_2026.md` | Loaded labor ~$30/hr; Price = costs / (1 − target GM) |

## Display units

- Mowing → **per visit** (weekly / bi-weekly frequency applies to mowing only; bi-weekly does **not** discount the visit rate)
- Fertilization → **per month** (program; no weekly/bi-weekly option)
- Weed control → **per treatment** (no weekly/bi-weekly option)
- Full service → **per month** (Complete mow visit rate × visits/mo + fert program; frequency not selectable in quote UI — defaults to weekly planning)
