 ...
 * @param {any} imageData - The image data object or URL string
 * @param {string} fallbackUrl - Fallback URL to use if the provided URL is invalid
 * @returns {string} A safe image URL
 */
export function getSafeImageUrl(imageData, fallbackUrl = "/placeholder.svg?height=400&width=600") {
